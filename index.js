...
function initMap() {
    ...
    const map = L.map('map').setView([37.5642, 126.9673], 10);
    ...
    const subways = [
        { name: "1호선", color: "rgba(29, 78, 216, 0.5)", coords: [[37.5546, 126.9706], [37.5657, 126.9769], [37.5702, 126.9831], [37.5716, 126.9918]] },
        { name: "2호선", color: "rgba(22, 163, 74, 0.5)", coords: [[37.5574, 126.9561], [37.5599, 126.9636], [37.5651, 126.9772], [37.5660, 126.9826], [37.5663, 126.9910]] },
        { name: "5호선", color: "rgba(147, 51, 234, 0.5)", coords: [[37.5537, 126.9567], [37.5599, 126.9636], [37.5657, 126.9666], [37.5752, 126.9768], [37.5716, 126.9918]] },
        { name: "경의중앙선", color: "rgba(37, 99, 235, 0.5)", coords: [[37.5546, 126.9706], [37.5598, 126.9636], [37.5601, 124.9458]] }
    ];

    subways.forEach(line => {
        L.polyline(line.coords, { color: line.color, weight: 8, opacity: 0.6, pane: 'topPane' })
        .addTo(map)
